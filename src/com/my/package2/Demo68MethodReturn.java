...
/*
题目要求：定义一个方法，用来【求出】两个数字之和，（你帮我算，算完结果告诉我）
题目要求：定义一个方法，用来【打印】两个数字之和，（你来计算，算完之后你自己负责显示结果，不用告诉我）

 注意事项：
 对于有返回值的方法，可以使用单独调用、打印调用、或者赋值调用
 但是对于无返回值的方法，只能使用单独调用，不能使用打印调用或者赋值调用
 */
public class Demo68MethodReturn {
    public static void main(String[] args) {
        ...
        System.out.println(getSum(2,3));//打印调用正确写法
